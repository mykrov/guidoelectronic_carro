                        ...
                        <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
                            ...
                            <div class="shop-head-menu">
                                ...
                                <li><i class="fa fa-home"></i><a class="shop-home" href="{{route('index')}}"><span>Inicio</span></a><span><i class="fa fa-angle-right"></i></span></li>
                                    <li class="shop-pro">Sobre Nosotros</li>
                                </ul>
                            </div>
                            <!--end-shop-head-->
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="about-text">
								...
								<p>{{$texto->where('seccion','Empresa_historia')->first()->parrafo}}</p>
                                
                            </div>	
                            <div class="about-text">
                                <h2>Misión</h2>
                                <p>{{$texto->where('seccion','Empresa_mision')->first()->parrafo}}</p>
                            </div>	
                            <div class="about-text">
                                <h2>Visión</h2>
                                <p>{{$texto->where('seccion','Empresa_vision')->first()->parrafo}}</p>
